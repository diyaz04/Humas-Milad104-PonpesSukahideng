    ...
    <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'glass-nav py-4 shadow-xl' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="bg-white p-0.5 border border-white rounded shadow-sm">
            <img 
          ...
          <div>
            <h1 className={`font-serif font-bold leading-none tracking-tight ${scrolled ? 'text-brand-gold text-lg' : 'text-brand-gold text-2xl'}`}>SUKAHIDENG</h1>
